...
public abstract class Light {
        ...
        public static final Color DefaultColor = new Color(0.75f, 0.75f, 0.75f, 0.75f);
    ...
    this.color.a = a;
        ...
        final RayCastCallback ray = new RayCastCallback() {
                ...
                final public float reportRayFixture(Fixture fixture, Vector2 point,
                        ...
                        if ((filterA != null) && !contactFilter(fixture) || fixture.isSensor())
                                return -1;
                        // if (fixture.isSensor())
                        // return -1;
                        Light.this.mx[Light.this.m_index] = point.x*C.BOX_TO_WORLD;
                        Light.this.my[Light.this.m_index] = point.y*C.BOX_TO_WORLD;
        ...
        final static boolean contactFilter(Fixture fixtureB) {
        	if (fixtureB == null)
                ...
                Object obj = fixtureB.getBody().getUserData();
                if (obj instanceof Bullet)
                	return false;
                if (obj instanceof ExplosiveObject)
                	return false;
