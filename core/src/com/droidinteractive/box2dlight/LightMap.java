...
public class LightMap {
        ...
        public LightMap(RayHandler rayHandler, int fboWidth, int fboHeight) {
                ...
                this.shadowShader = ResourceManager.getShader("shadow");
                this.diffuseShader = ResourceManager.getShader("diffuse");
                this.withoutShadowShader = ResourceManager.getShader("noshadow");

                this.blurShader = ResourceManager.getShader("gaussian");
